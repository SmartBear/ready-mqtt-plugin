package com.smartbear.mqttsupport.teststeps.actions;
...
import com.smartbear.mqttsupport.teststeps.actions.StopTestStepAction;
...
public class RunTestStepAction extends AbstractAction implements Runnable, CancellationToken {
    ...
    public StopTestStepAction getCorrespondingStopAction(){return stopAction;}
